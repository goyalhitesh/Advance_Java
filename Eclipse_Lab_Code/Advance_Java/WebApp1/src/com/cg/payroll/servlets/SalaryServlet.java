...
public class SalaryServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html><body><div align='center'>"+
				"<h2 style='color:Powderblue;'>Bank Details</h2>"+
				"<form name='BankDetails' action='#' method='post'>"+
				"<table bgcolor='Slateblue'><tr><td>Bank Name:</td>"+
				...
				"<option name='bankName' value='Citi Bank'>Citi '</option>"+
				"<option name='bankName' value='Central Bank of India'>Central Bank of India</option>"+
				"</select></td></tr><tr><td>Account Number:</td><td>"+
				"<input type='number' name='accountNumber' minlength='10' maxlength='20' required></td></tr>"+
				"<tr><td>Bank IFSC Code:</td><td>"+
				"<input type='text' name='ifscCode' pattern='([A-Z]{4}[A-Z0-9]{7})' placeholder='ABCDE123456' required></td>"+
				"</tr></table><br><button type='submit' name='next'>Next</button><button type='reset' name='reset'>Reset</button>"+
				"</form></div></body></html>");
	}
}
